...
$transactionNumber = ''; // Initialize the variable to avoid undefined variable warning
?>
...
<script>
    ...
    function redirectToAnotherPage(concertId, seats, quantity, seatscount, transactionNumber) {
        if (pinCorrect) {
            window.location.href = 'paymentinfocredit.php?concert_id=' + concertId + '&selected_seats=' + seats + '&total_price=' + quantity + '&count=' + seatscount + '&transaction_no=' + transactionNumber;
        } else {
