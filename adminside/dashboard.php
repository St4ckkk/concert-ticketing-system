...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="images/hands-up (2).png">
...
<div class="sidebar">
    <img src="uploaded_img/images/hands-up (2).png" alt="Logo">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="avatar-container">
                                    <img src="uploaded_img/boy.png" alt="Avatar" class="avatar">
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                <script>
                                    function updateClock() {
                                        ...
                                        const timeString = manilaTime.split(',')[1].trim(); // Extract time part
